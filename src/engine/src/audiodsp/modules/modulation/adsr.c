 ...
 */
void v_adsr_set_adsr(t_adsr* a_adsr_ptr, SGFLT a_a,
        SGFLT a_d, SGFLT a_s, SGFLT a_r)
{
...
void v_adsr_set_adsr_lin_from_db(t_adsr* a_adsr_ptr, SGFLT a_a,
        SGFLT a_d, SGFLT a_s, SGFLT a_r)
{
 ...
 */
void v_adsr_set_adsr_db(t_adsr* a_adsr_ptr, SGFLT a_a,
        SGFLT a_d, SGFLT a_s, SGFLT a_r)
{
    v_adsr_set_a_time(a_adsr_ptr, a_a);
    v_adsr_set_d_time(a_adsr_ptr, a_d);
