...
#define LMS_SAMPLE_VOLUME_PORT_RANGE_MIN    SAMPLER1_PLAY_PITCH_HIGH_PORT_RANGE_MAX
#define SAMPLER1_SAMPLE_VOLUME_PORT_RANGE_MAX    (LMS_SAMPLE_VOLUME_PORT_RANGE_MIN + SAMPLER1_MAX_SAMPLE_COUNT)
