...
class va1_plugin_ui(AbstractPluginUI):
    def __init__(self, *args, **kwargs):
        ...
        self.osc1 = osc_widget(
            f_knob_size, VA1_OSC1_PITCH,
            VA1_OSC1_TUNE, VA1_OSC1_VOLUME,
            VA1_OSC1_TYPE, f_osc_types,
        ...
        self.adsr_filter = adsr_widget(
            ...
            VA1_FILTER_RELEASE, _("ADSR Filter"),
            self.plugin_rel_callback, self.plugin_val_callback,
        ...
        self.filter_keytrk = knob_control(
            f_knob_size, _("KeyTrk"), VA1_FILTER_KEYTRK,
            self.plugin_rel_callback, self.plugin_val_callback,
        ...
        self.filter_velocity = knob_control(
            f_knob_size, _("Vel."), VA1_FILTER_VELOCITY,
            self.plugin_rel_callback, self.plugin_val_callback,
            0, 100, 0, KC_NONE, self.port_dict, self.preset_manager)
        ...
        self.lfo_pitch = knob_control(
            f_knob_size, _("Pitch"), VA1_LFO_PITCH,
            self.plugin_rel_callback, self.plugin_val_callback,
        ...
        self.lfo_pitch_fine = knob_control(
            f_knob_size, _("Fine"), VA1_LFO_PITCH_FINE,
            self.plugin_rel_callback, self.plugin_val_callback,
        ...
        self.lfo_cutoff = knob_control(
            f_knob_size, _("Filter"), VA1_LFO_FILTER,
            self.plugin_rel_callback, self.plugin_val_callback,
